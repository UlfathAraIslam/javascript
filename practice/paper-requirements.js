...
function paperRequirements(copyOfFirstBook, copyOfSecondtBook, copyOfThirdBook) {
    return copyOfFirstBook + copyOfSecondtBook + copyOfThirdBook;
}
const total = paperRequirements(100, 200, 300);
console.log(total)